...
public class AchievementsAdapter extends ArrayAdapter<Instance> {

    private int colorResourceId;

    public AchievementsAdapter(Activity context, ArrayList<Instance> instances, int colorId) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if(listItemView == null) {
            listItemView = LayoutInflater.from(getContext()).inflate(
                    R.layout.list_achievements, parent, false);
        }
