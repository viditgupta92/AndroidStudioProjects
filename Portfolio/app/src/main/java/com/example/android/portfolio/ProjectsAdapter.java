...
public class ProjectsAdapter extends ArrayAdapter<Instance> {

    private int colorResourceId;

    public ProjectsAdapter(Activity context, ArrayList<Instance> instances, int colorId) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if(listItemView == null) {
            listItemView = LayoutInflater.from(getContext()).inflate(
                    R.layout.list_projects, parent, false);
        }
        ...
        // Find the TextView in the list_educationation.xml layout with the ID version_name
        TextView languagesTextView = (TextView) listItemView.findViewById(R.id.language_text_view);
        // Get the version name from the current AndroidFlavor object and
        // set this text on the name TextView
        languagesTextView.setText(currentInstance.getLanguages());
